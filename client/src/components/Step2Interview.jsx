...
//         runIntro();
//       },[selectedVoice, isIntroPhase, currentIndex, currentQuestion, isMicOn]);
...
//           initial={{ opacity: 0 }}
//           animate={{ opacity: 1 }}
//           className='mt-6 bg-emerald-50 border border-emerald-200p-5 rounded-2xl shadow-sm'>
//             <p className='text-emerald-700 font-medium mb-4'>{feedback}</p>

//             <button className='w-full bg-gradient-to-r from-emerald-600 to-teal-500 text-white py-3 rounded-xl shadow-md hover:opacity-90 transition'>
//               {currentIndex === questions.length - 1 ? "Finish Interview" : "Next Question " + <BsArrowRight size={20} />}
//             </button>
//           </motion.div>)}
//         </div>
//       </div>
